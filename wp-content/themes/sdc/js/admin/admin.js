$(function(){
    ...
    if ($('#page_template option:selected').val() != 'pageSmm.php') {
        $('#smm-section, #advantages-section, #doing-section, #team-section, #video-section, #header-smm-section, #smm-kazakhstan-section, #smm-questions-section').addClass('hidden');
